...
export default class DecafParser extends antlr4.Parser {
    ...
    static ruleNames = [ "program", "declaration", "varDeclaration", "structDeclaration", 
                         ...
                         "expression", "methodCall", "arg", "literal", "char_literal", 
	...
	block() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << DecafParser.T__2) | (1 << DecafParser.T__12) | (1 << DecafParser.T__15) | (1 << DecafParser.T__17) | (1 << DecafParser.T__18) | (1 << DecafParser.T__25))) !== 0) || ((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (DecafParser.T__34 - 35)) | (1 << (DecafParser.T__35 - 35)) | (1 << (DecafParser.T__36 - 35)) | (1 << (DecafParser.T__37 - 35)) | (1 << (DecafParser.ID - 35)) | (1 << (DecafParser.DIGIT - 35)))) !== 0)) {
	            this.state = 141;
	            this.statement();
	            this.state = 146;
	            this._errHandler.sync(this);
	...
	methodCall() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(((((_la - 13)) & ~0x1f) == 0 && ((1 << (_la - 13)) & ((1 << (DecafParser.T__12 - 13)) | (1 << (DecafParser.T__25 - 13)) | (1 << (DecafParser.T__34 - 13)) | (1 << (DecafParser.T__35 - 13)) | (1 << (DecafParser.T__36 - 13)) | (1 << (DecafParser.T__37 - 13)) | (1 << (DecafParser.ID - 13)) | (1 << (DecafParser.DIGIT - 13)))) !== 0)) {
	            this.state = 243;
	            this.arg();
	            this.state = 248;
	            this._errHandler.sync(this);
	...
	char_literal() {
	    ...
	    this.enterRule(localctx, 32, DecafParser.RULE_char_literal);
	    try {
	...
	int_literal() {
	    ...
	    this.enterRule(localctx, 34, DecafParser.RULE_int_literal);
	    try {
	...
	bool_literal() {
	    ...
	    this.enterRule(localctx, 36, DecafParser.RULE_bool_literal);
	    try {
	        this.state = 273;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	id() {
	    ...
	    this.enterRule(localctx, 38, DecafParser.RULE_id);
	    try {
	...
	num() {
	    ...
	    this.enterRule(localctx, 40, DecafParser.RULE_num);
	    try {
...
DecafParser.RULE_char_literal = 16;
DecafParser.RULE_int_literal = 17;
DecafParser.RULE_bool_literal = 18;
DecafParser.RULE_id = 19;
DecafParser.RULE_num = 20;
